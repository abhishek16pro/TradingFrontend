...
import * as StgFunction from './StgFunction'
...
function AddLeg(props) {
    const { stgTag, stgList } = props;
    // console.log(stgTag);F
    // Create rows dynamically based on props.legCount
    const [legData, setLegData] = useState([
        { id: 1, idle: false, lot: 1, side: 'S', cepe: "C", strike: '', strikeValue: null, wt: null, targetType: null, tgtvalue: null, stoplossType: null, slValue: null, trail: null, onTarget: [], onTargetNoT: null, onSL: [], onSLNoT: null },
        { id: 2, idle: false, lot: 1, side: 'S', cepe: "C", strike: '', strikeValue: null, wt: null, targetType: null, tgtvalue: null, stoplossType: null, slValue: null, trail: null, onTarget: [], onTargetNoT: null, onSL: [], onSLNoT: null }
    ])
    ...
    const handleLots = (index, e) => {
        const updatedLegData = [...legData];
        const objectIndex = updatedLegData.findIndex((item) => item.id === index + 1);
        if (objectIndex !== -1) {
            updatedLegData[objectIndex].lot = e.target.value
            setLegData(updatedLegData);
        }
        // console.log(legData);
    }
    ...
    const handleStgName = (e) => {
        const updatedLegData = StgSetting
        updatedLegData.stgName = e.target.value
        setStgSetting(updatedLegData)
        // console.log(StgSetting);
    };
    ...
    const handleStgTag = (e) => {
        const updatedLegData = StgSetting
        updatedLegData.stgTag = e.target.value.tag
        setStgSetting(updatedLegData)
        // console.log(StgSetting);
    };
        ...
        <div >
            <Box>
                ...
                <TextField
                    ...
                    size="small"
                    onChange={handleStgName}
                    sx={{ width: '180px', mt: '15px', marginLeft: '5px' }}
                />

                <FormControl margin='normal' size='small' style={{ marginLeft: "5px", width: "150px" }} >
                    <InputLabel id="demo-simple-select-label" size='small' >Strategy Tag</InputLabel>
                    <Select
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                        onChange={(e) => handleStgTag(e)}
                        // value={StgSetting.stgTag}
                        label="Type"
                    // onChange={handleInput}
                    >
                        {stgTag.map((type, index) => {
                            return <MenuItem value={type} key={index} >{type.tag}</MenuItem>
                        })}
                    </Select>
                </FormControl>
                ...
                <Table sx={{ maxWidth: '100%' }} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="center" sx={{ padding: '0px' }} >Lots</TableCell>
                        ...
                        {legData.map((row, index) => (
                            ...
                            >
                                ...
                                <TableCell align="center" sx={{ padding: '5px' }} >
                                    <input value={row.lot} type='number' onChange={(e) => handleLots(index, e)} style={{ width: "30px" }} />
                                </TableCell>
                                ...
                                <TableCell align="center" sx={{ padding: '0px' }} >
                                    <TextField type='Number' onChange={(e) => handleStrikeValue(index, e)} id="strikevalue" label="" size="small" variant="standard" sx={{ width: "60px" }} style={{ textAlign: 'center' }} />
                                </TableCell>

                                <TableCell align="center" sx={{ padding: '0px' }} >
                                    <TextField onChange={(e) => handleWnT(index, e)} id="wt" label="" size="small" variant="standard" sx={{ width: "60px" }} />
                                </TableCell>
                                ...
                                <TableCell align="center" sx={{ padding: '0px' }} >
                                    <TextField onChange={(e) => handleTGTValue(index, e)} variant="standard" sx={{ width: "60px" }} />
                                </TableCell>
                                ...
                                <TableCell align="center" sx={{ padding: '0px' }} >
                                    <TextField onChange={(e) => handleSLValue(index, e)} variant="standard" sx={{ width: "60px" }} />
                                </TableCell>


                                <TableCell align="center" sx={{ padding: '0px' }} >
                                    <TextField type='Number' onChange={(e) => handleTrail(index, e)} variant="standard" sx={{ width: "60px" }} />
                                </TableCell>
                                    ...
                                    <FormControl margin="normal" sx={{ width: "100px" }}>
                                        ...
                                        >
                                            {onTGTSL.map((type, index) => {
                                                return <MenuItem value={type} key={index}> <Checkbox checked={row.onTarget.includes(type)} />{type}  </MenuItem>;
                                            })}
                                        </Select>
                                    </FormControl>
                                </TableCell>
                                ...
                                <TableCell align="center" sx={{ padding: '0px' }} >
                                    {legData[index].onTarget.includes("ReExecute") || legData[index].onTarget.includes("ReEntry") ? <TextField type='Number' variant="standard" onChange={(e) => handleonTargetNoT(index, e)} sx={{ width: "60px" }} /> : <TextField disabled type='Number' variant="standard" onChange={(e) => handleonSLNoT(index, e)} sx={{ width: "60px" }} />}
                                </TableCell>
                                ...
                                <TableCell align="center" sx={{ padding: '0px' }} >
                                    <FormControl margin="normal" sx={{ width: "100px" }}>
                                        ...
                                        >
                                            {onTGTSL.map((type, index) => {
                                                return <MenuItem value={type} key={index}> <Checkbox checked={row.onSL.includes(type)} />{type}  </MenuItem>;
                                            })}
                                        </Select>
                                    </FormControl>
                                </TableCell>
                                ...
                                <TableCell align="center" sx={{ padding: '0px' }} >
                                    {legData[index].onSL.includes("ReExecute") || legData[index].onSL.includes("ReEntry") ? <TextField type='Number' variant="standard" onChange={(e) => handleonSLNoT(index, e)} sx={{ width: "60px" }} /> : <TextField disabled type='Number' variant="standard" onChange={(e) => handleonSLNoT(index, e)} sx={{ width: "60px" }} />}
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
